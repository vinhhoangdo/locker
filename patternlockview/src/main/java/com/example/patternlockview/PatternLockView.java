...
import static com.example.patternlockview.PatternLockView.AspectRatio.ASPECT_RATIO_HEIGHT_BIAS;
import static com.example.patternlockview.PatternLockView.AspectRatio.ASPECT_RATIO_SQUARE;
import static com.example.patternlockview.PatternLockView.AspectRatio.ASPECT_RATIO_WIDTH_BIAS;
import static com.example.patternlockview.PatternLockView.PatternViewMode.AUTO_DRAW;
import static com.example.patternlockview.PatternLockView.PatternViewMode.CORRECT;
import static com.example.patternlockview.PatternLockView.PatternViewMode.WRONG;
...
public class PatternLockView extends View {
    ...
    private void startSizeAnimation(float start, float end, long duration,
                                    android.view.animation.Interpolator interpolator, final DotState state,
